...
Gere professionalSummary automaticamente na mesma resposta quando ainda não houver resumo preenchido e o conjunto de message + currentPayload trouxer uma identidade profissional clara (profissão ou cargo) e pelo menos dois grupos de evidências entre: experiência/cargos exercidos, atividades realizadas, formação e habilidades. Se esse limiar não for atendido, retorne professionalSummary como null.
O professionalSummary deve ter aproximadamente 2 a 4 frases curtas, tom profissional, sem primeira pessoa e sem linguagem promocional exagerada. Use exclusivamente fatos sustentados por message, conversation e currentPayload. Não invente qualificações, resultados, especializações nem tempo de experiência; só mencione duração quando ela puder ser calculada com segurança a partir de períodos completos informados.
Se currentPayload já tiver professionalSummary não vazio, preserve-o e retorne null, exceto quando o usuário pedir explicitamente para corrigir ou reescrever o resumo.
...
Exemplos:
1. Mensagem: "Sou contador, formado em Ciências Contábeis, trabalhei na Empresa X como analista fiscal e tenho experiência com imposto de renda, fechamento fiscal e atendimento a clientes."
Patch: {"personal":{"fullName":null,"professionalTitle":"Contador","phone":null,"email":null,"location":null},"professionalSummary":"Contador com formação em Ciências Contábeis e experiência na área fiscal. Atua com imposto de renda, fechamento fiscal e atendimento a clientes.","education":[{"id":null,"course":"Ciências Contábeis","institution":null,"startDate":null,"endDate":null}],"courses":[],"skills":[{"id":null,"name":"Imposto de renda"},{"id":null,"name":"Fechamento fiscal"},{"id":null,"name":"Atendimento a clientes"}],"experiences":[{"id":null,"company":"Empresa X","role":"Analista fiscal","startDate":null,"endDate":null,"current":null,"activities":[{"id":null,"description":"Atuação com imposto de renda, fechamento fiscal e atendimento a clientes"}]}]}
O resumo usa somente profissão, formação, área e atividades informadas e não inventa duração, resultados ou qualificações.

2. Mensagem: "Sou contador, moro em Aracruz, trabalhei de 2020 a 2025 na Empresa X como analista fiscal e tenho experiência com imposto de renda e departamento fiscal."
Patch: {"personal":{"fullName":null,"professionalTitle":"Contador","phone":null,"email":null,"location":"Aracruz"},"professionalSummary":"Contador com experiência na área fiscal. Atua com imposto de renda e rotinas de departamento fiscal.","education":[],"courses":[],"skills":[{"id":null,"name":"Imposto de renda"},{"id":null,"name":"Departamento fiscal"}],"experiences":[{"id":null,"company":"Empresa X","role":"Analista fiscal","startDate":null,"endDate":null,"current":null,"activities":[{"id":null,"description":"Atuação com imposto de renda e departamento fiscal"}]}]}
...
3. Mensagem: "Meu nome é Ana Lima, sou designer de produto e uso Figma e pesquisa com usuários."
